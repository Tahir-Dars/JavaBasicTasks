...
//        else System.out.println("It is Neither");
      // challenge B:Prompt user to enter a number and determine if it's even or odd.
//        System.out.print("Enter any number: ");
//        int eo=sk.nextInt();
//
//        if(eo%2==0){
...
//    }
        //challenge C:Prompt user to enter three numbers and identify if they are equal or find the largest among them.
